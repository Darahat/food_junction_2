...
<head>
    ...
    <link rel="stylesheet" href="{{ URL::asset('datatable/css/dataTables.bootstrap.min.css') }}">
    <link rel="stylesheet" href="{{ URL::asset('datatable/css/dataTables.bootstrap4.min.css') }}">
...
<body>
          ...
          <div class="row" style="margin-top: 45px">
              ...
              <div class="col-md-4">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <form class="row gy-2 gx-3 align-items-center" action="{{ route('add.country') }}" method="post" id="add-country-form" autocomplete="off">
                                @csrf
                                <div class="col-12">
                                ...
                                <div class="col-12">
                                    <label for="" class="form-label">Capital city</label>
    ...
    <script src="{{ URL::asset('datatable/js/jquery.dataTables.min.js') }}"></script>
    <script src="{{ URL::asset('datatable/js/dataTables.bootstrap4.min.js') }}"></script>
