...
<div class="container">
   ...
   <div class="row">
        <div class="col-sm-9"><h3>Item Types</h3></div>
...
@include('product_type/add-type-modal')
@include('product_type/edit-type-modal')
    ...
    <script>
         ...
         $(function(){
               ...
               var table =  $('#types-table').DataTable({
                     processing:true,
                     info:true,
                     ajax:"{{ route('get.product_type.list2') }}",
                     "pageLength":5,
                ...
                $(document).on('click','#editTypeBtn', function(){
                    ...
                    $.post('<?= route("get.product_type.details2") ?>',{"_token": "{{ csrf_token() }}",type_id:type_id}, function(data){
                ...
                $(document).on('click','#deleteTypeBtn', function(){
                    var type_id = $(this).data('id');
                    var url = '<?= route("delete.product_type") ?>';

                    swal.fire({
                         title:'Are you sure?',
                         html:'You want to <b>delete</b> this Item Type',
           ...
           $(document).on('click','button#deleteAllBtn', function(){
               ...
               var url = '{{ route("delete.selected.product_type") }}';
